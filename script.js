...
async function processData() {
    ...
    window.allCanvassingData = allCanvassingData; // Make accessible globally for debugging if needed
...
function filterDataByMonth(data, selectedMonthValue) {
    ...
    return data.filter(entry => {
        ...
        // --- MODIFICATION HERE: Use the robust parseDateWithTime function ---
        const entryDate = parseDateWithTime(timestampValue);
